...
print("assembling")
MASTER = "Hriiiitiik Shreevaaastaw"
...
def wishMe():
    ...
    speak("i am rava your virtual assistatant design by Hriiiitiik Shreevaaastaw")
...
def takeCommand():
    ...
    with sr.Microphone() as source:
        print("SAY ANTHING YOU WANT")
        audio = r.listen(source)

    try :
        print("sochne do kya kiya jaaye")
...
def main():
    ...
    if 'wikipedia' in query.lower():
        ...
        try:
            ...
            speak("Email has been sent to hriytik")
        except Exception as e:
            print(e)
